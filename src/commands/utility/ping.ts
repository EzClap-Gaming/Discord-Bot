    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    `Hier sind die aktuellen Ping-Werte des Discord-Bots und des Servers:`,
                )
                .addFields(
                    { name: "🤖 Discord Bot", value: `${botLatency}ms`, inline: true },
                    {
                        name: "🖥️ Server Latenz",
            ...
            await interaction.editReply({
                content:
                    "❌ Es konnte keine Latenz gemessen werden. Bitte versuche es später erneut.",
            });
        }
    },
};
