        ...
        try {
            ...
            const createEmbed = (page: number) => {
                const embed = new EmbedBuilder()
                    ...
                    .setFooter({
                        text: `Seite ${page + 1} von ${categoryData.length}`,
            ...
            collector.on("end", async () => {
                const disabledButtons = createButtons(currentPage).components.map((btn) =>
            ...
            await interaction.reply({
                content:
                    "Es ist ein Fehler beim Erstellen der Hilfe aufgetreten. Bitte versuche es später noch einmal.",
                ephemeral: true,
            });
        }
    },
