    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            exec("pm2 restart Bot-EzClap", (error, stdout, stderr) => {
                if (error) {
                    ...
                    const errorEmbed = new EmbedBuilder()
                        .setColor("Random")
                        .setDescription(
                            "⚠️ Ein Fehler ist beim Neustart des Bots über PM2 aufgetreten. Bitte versuche es später erneut.",
                        );
            ...
            const errorEmbed = new EmbedBuilder()
                .setColor("Random")
                .setDescription(
                    "⚠️ Ein Fehler ist beim Neustart aufgetreten. Bitte versuche es später erneut.",
                );
