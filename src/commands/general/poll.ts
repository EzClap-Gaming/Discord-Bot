...
const PollCommand: Command = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option.setName("question").setDescription("Die Frage der Umfrage").setRequired(true),
        )
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const pollEmbed = new EmbedBuilder()
            ...
            .setFooter({
                text: `Umfrage erstellt von ${interaction.user.username}`,
        ...
        setTimeout(async () => {
            ...
            const resultEmbed = new EmbedBuilder()
                ...
                .setFooter({
                    text: `Umfrage beendet von ${interaction.user.username}`,
                    iconURL: interaction.user.displayAvatarURL(),
                })
                .setTimestamp();
